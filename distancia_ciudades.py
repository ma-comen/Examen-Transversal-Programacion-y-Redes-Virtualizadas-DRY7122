...
while True:
    ...
    transporte = input("Medio de transporte (auto, avion, caminando, etc.): ")
    ...
    # Estimacion de duracion segun transporte (puedes ajustar los promedios)
    ...
    print(f"Duracion estimada en {transporte}: {duracion_horas:.2f} horas")
    print(f"Narrativa: El viaje desde {origen.title()} hasta {destino.title()} en {transporte} cubre aproximadamente {distancia_km:.2f} kilometros.")